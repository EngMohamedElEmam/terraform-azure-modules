...
export COMMON_RESOURCE_GROUP_NAME=terraform
export TF_STATE_STORAGE_ACCOUNT_NAME=emamterraform
export TF_STATE_CONTAINER_NAME=tf-state
export KEYVAULT_NAME=emamterraform-kv
